...
export default function Step() {
  return (
    <div id="howitworks" className="relative py-24 px-5 bg-gradient-to-b from-indigo-950 to-slate-900">
      {/* Background decoration */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 right-40 w-64 h-64 rounded-full bg-purple-500 blur-3xl"></div>
        <div className="absolute bottom-20 left-40 w-72 h-72 rounded-full bg-blue-500 blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {/* Step 1 */}
          <div className="bg-slate-900/50 border border-indigo-900/30 rounded-2xl p-8 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/10 hover:translate-y-[-4px]">
            <div className="flex gap-4 items-start flex-col">
              <div className="flex items-center justify-between w-full">
                <span className="text-violet-400 bg-violet-500/10 p-4 rounded-xl shadow-inner shadow-violet-900/20">
                  <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
              ...
              <div>
                <h3 className="font-bold text-2xl text-white mt-4">Paste your JSON</h3>
                <p className="mt-3 text-gray-300 leading-relaxed">JSON is widely used but can be challenging to handle. This website simplifies processing JSON data with a user-friendly interface.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-indigo-900/30 rounded-2xl p-8 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/10 hover:translate-y-[-4px]">
            <div className="flex gap-4 items-start flex-col">
              ...
              <div>
                <h3 className="font-bold text-2xl text-white mt-4">Visualize Graph</h3>
                <p className="mt-3 text-gray-300 leading-relaxed">Once the data is prepared, you can effortlessly display the values using various types of graphs and customizable settings.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-indigo-900/30 rounded-2xl p-8 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/10 hover:translate-y-[-4px]">
            <div className="flex gap-4 items-start flex-col">
              ...
              <div>
                <h3 className="font-bold text-2xl text-white mt-4">Use the Graph</h3>
                <p className="mt-3 text-gray-300 leading-relaxed">Once the graph is prepared, export it as an image. Additional features such as saving the graph for future use or embedding it into other websites are coming soon.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-16">
          <div className="w-16 h-1 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-full"></div>
        </div>
      </div>
    </div>
  )
